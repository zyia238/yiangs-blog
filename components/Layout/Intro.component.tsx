...
const Intro : FC<IntroProps> = ({jsonData}) => {
    ...
    return (
        <div className='m-box flex-1 rounded-md shadow-md shadow-[#d4d4d5]'>
            <div >
                <Image src={require('@/assets/avatar.jpeg')} alt="avatar" className='w-full h-auto'/>
            </div>
            <div>
                <div className="text-center fontbold p-1">
                    Yiang Zhou
                </div>
                ...
                <div className="flex px-3 py-4 justify-center items-center border-t-[rgba(34, 36, 38, .1)]">
                          <a href="https://github.com/zyia238" className='flex items-center justify-center text-center w-[38px] h-[38px] leading-[38px] rounded-[50%] bg-[#e0e1e2] text-[rgba(0,0,0,.6)]'>
                ...
                <a href="mailto:zhouyiang0629@hotmail.com" className='flex items-center justify-center text-center w-[38px] h-[38px] leading-[38px] rounded-[50%] bg-[#e0e1e2] text-[rgba(0,0,0,.6)]'>
